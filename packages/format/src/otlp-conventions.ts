...
export const ATTR_IMPL = "benchkit.impl";

/** Free-form grouping: dataset. Optional. */
export const ATTR_DATASET = "benchkit.dataset";

/** Free-form grouping: transport. Optional. */
export const ATTR_TRANSPORT = "benchkit.transport";

/** Free-form grouping: batch size. Optional. */
export const ATTR_BATCH_SIZE = "benchkit.batch_size";

/** Free-form grouping: process. Optional. */
export const ATTR_PROCESS = "benchkit.process";

/** Free-form grouping: pipeline. Optional. */
export const ATTR_PIPELINE = "benchkit.pipeline";

/** Free-form grouping: variant. Optional. */
export const ATTR_VARIANT = "benchkit.variant";
