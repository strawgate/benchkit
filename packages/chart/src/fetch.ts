...
import { compareRuns as formatCompareRuns, detailViewToBenchmarkResult } from "@benchkit/format";
...
export async function compareRuns(
  ...
  const comparison = formatCompareRuns(currentResult, [baselineResult], threshold);
